...
public class EmployeeController {
    ...
    public Employee updatedoctorStatus(@PathVariable("id") int id, @RequestParam  Status status) {
        return employeeService.changeStatus(id, status);
    }

    @PatchMapping("/{id}/department")
    public Employee updateDoctorDepartment(@PathVariable Integer id, @RequestParam String department) {
